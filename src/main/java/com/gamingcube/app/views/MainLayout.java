package com.gamingcube.app.views;
...
import com.gamingcube.app.views.masterdetail.MasterDetailView;
import com.gamingcube.app.views.collaborativemasterdetail.CollaborativeMasterDetailView;
import com.gamingcube.app.views.imagelist.ImageListView;
import com.gamingcube.app.views.checkoutform.CheckoutFormView;
import com.vaadin.flow.component.avatar.Avatar;

/**
 * The main view is a top-level placeholder for other views.
 */
@PWA(name = "GamingCube", shortName = "GamingCube", enableInstallPrompt = false)
@Push
@Theme(themeFolder = "gamingcube", variant = Lumo.DARK)
@PageTitle("Main")
